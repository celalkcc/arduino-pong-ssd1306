...
int ySpeed; // sets Speed for y and x axis
int xSpeed; //The Bottleneck for Gamespeed is the i2s bus for the display which has a huge buffer size, game runs just comparably fast on any hardware.
